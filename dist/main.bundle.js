...
var AppService = (function () {
    function AppService(http, route, gd) {
        ...
        this.subject = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["b" /* Subject */]();
        this.go = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["b" /* Subject */]();
        this.connectServer();
    }
    ...
    AppService.prototype.month = function (de, ate, field, limit) {
        if (limit == undefined)
            limit = '3';
        var url = this.host + 'month.php?param1=data&valor1=2017&param2=data&valor2=' + de + '&param3=data&valor3=' + ate + '&param4=' + field + '&limit=' + limit; //&param2=doenca&valor2=a
        return this.http.get(url);
    };
...
DemoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__app_data__["a" /* AppData */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__app_data__["a" /* AppData */]) === "function" && _b || Object])
], DemoComponent);
...
var RoscaComponent = (function () {
    ...
    RoscaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.graph = setInterval(function () { return _this.drawChart(); }, 2000);
    };
    RoscaComponent.prototype.ngOnDestroy = function () {
    };
    RoscaComponent.prototype.drawChart = function () {
        var _this = this;
        ...
        //
        google.visualization.events.addListener(this.localchart, 'select', function (a, b, c) {
            var selectedItem = _this.localchart.getSelection()[0];
            //console.log(selectedItem);
            _this.localchart.setSelection(selectedItem);
            if (selectedItem) {
                var topping = _this.dataChart.getValue(selectedItem.row, 0);
    ...
    RoscaComponent.prototype.selectHandler = function (self) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], RoscaComponent.prototype, "namex", void 0);
...
module.exports = "<div class=\"row\">\n   <div class=\"col-md-1\">\n   </div>\n   <div class=\"col-md-6\">\n       <!--div class=\"col-md-2\">\n       </div>\n       <div class=\"col-md-2\">\n         <select [(ngModel)]=\"filter3\" (change)=\"filter()\">\n            <option *ngFor=\"let v of filter2;\" [value]=\"v.value\">{{v.name}}</option>\n         </select>\n       </div>\n       <div class=\"col-md-2\">\n       </div-->\n      <div *ngIf=\"getMore\">{{cliqued.name}}</div>\n      <div *ngIf=\"getMore\" class=\"page\">   \n       <table *ngIf=\"getMore\" class=\"table table-striped\">\n           <tr  *ngFor=\"let d of cliqued.children; let i = index\">\n                <td>{{d.name}}</td><td>{{d.value}}</td>\n           </tr>\n       </table>\n     </div>\n\n   </div>\n   <div class=\"col-md-1\">\n   </div>\n</div>\n<div class=\"row\">\n   <div class=\"col-md-1\"></div>\n   <div class=\"col-md-6\">\n\n   </div>\n   <div class=\"col-md-1\"></div>\n</div>\n\n<div class=\"row clean\"></div>\n\n<div class=\"row\">\n   <div class=\"col-md-1\"></div>\n   <div class=\"col-md-6\">\n       <div id='treemap' class='treemap'></div>\n   </div>\n   <div class=\"col-md-1\"></div>\n</div>\n"
...
var SunburstComponent = (function () {
    ...
    SunburstComponent.prototype.getClicked = function (a) {
    ...
    SunburstComponent.prototype.sunmap = function (data) {
        ...
        d3.param = {};
        //var root = datad3;
        var margin = { top: 250, right: 380, bottom: 250, left: 380 }, radius = Math.min(margin.top, margin.right, margin.bottom, margin.left) - 10;
...
/***/ "../../../../../src/app/webservice/graph-control/graph-control.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/webservice/graph-control/graph-control.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"row margin\">\r\n    <div class=\"row margin\">\r\n        <div class=\"col-md-1\"></div>\r\n        <div class=\"col-md-8\">\r\n            Visualizar e analisar a quantidade de casos de surto de uma determinada epidemia, comparar em diferentes escalas temporais a incidência de cada doença e a unidade notificadora da doença (bairro), analisar a estatística usando diferentes técnicas de visualização, temporal, espacial entre outras, relacionando os valores de uma alteração da quantidade de casos, através do tempo e do espaço da doença.\r\n        </div>\r\n        <div class=\"col-md-1\"></div>\r\n    </div>\r\n    <div class=\"row margin\">\r\n      <div class=\"col-md-1\"></div>\r\n      <div class=\"col-md-5\">\r\n         <div id=\"{{miniName}}\"></div>\r\n      </div>\r\n      <div class=\"col-md-4\">\r\n\r\n      </div>\r\n   </div>\r\n   <div class=\"row margin\">\r\n       <div class=\"col-md-9\">\r\n             <table *ngIf=\"clicked\" class=\"table table-striped\">\r\n                 <tr  *ngFor=\"let d of clicked; let i = index\">\r\n                      <td>{{header[i]}}</td>\r\n                     <td>{{clicked[i]}}</td>\r\n                 </tr>\r\n           </table>\r\n         <div id=\"columnchart_values\"></div>\r\n       </div>\r\n   </div>\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/webservice/graph-control/graph-control.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphControlComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_data__ = __webpack_require__("../../../../../src/app/app.data.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GraphControlComponent = (function () {
    function GraphControlComponent(AppData) {
        this.AppData = AppData;
        this.miniData = [1, 1, 1, 1];
        this.miniLabel = ['1', '2', '3', '4'];
        this.miniLegenda = '*Nº de casos por doença';
        this.miniName = 'x1';
        this.miniMeses1 = ['1', '2', '3', '4'];
    }
    GraphControlComponent.prototype.ngOnInit = function () {
    };
    GraphControlComponent.prototype.open = function () {
        var _this = this;
    ...
    GraphControlComponent.prototype.rosca = function () {
    ...
    GraphControlComponent.prototype.open_month = function (data) {
        var _this = this;
        google.charts.load("current", { packages: ['corechart'] });
        google.charts.setOnLoadCallback(function () {
            _this.other(data);
    ...
    GraphControlComponent.prototype.other = function (data) {
        var _this = this;
        var list = data[0].doenca.split(',');
        var header = ['Meses'].concat(list);
        this.header = header;
        var tmp = [header];
        var con = [];
        var cov = [];
    ...
    GraphControlComponent.prototype.updateMiniData = function (label) {
...
], GraphControlComponent.prototype, "miniData", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], GraphControlComponent.prototype, "miniLabel", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], GraphControlComponent.prototype, "miniLegenda", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], GraphControlComponent.prototype, "miniName", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], GraphControlComponent.prototype, "miniMeses1", void 0);
GraphControlComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-graph-control',
        template: __webpack_require__("../../../../../src/app/webservice/graph-control/graph-control.component.html"),
        styles: [__webpack_require__("../../../../../src/app/webservice/graph-control/graph-control.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__app_data__["a" /* AppData */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__app_data__["a" /* AppData */]) === "function" && _a || Object])
...
/***/ "../../../../../src/app/webservice/graph-control/graph-control.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphControlModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__graph_control_component__ = __webpack_require__("../../../../../src/app/webservice/graph-control/graph-control.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GraphControlModule = (function () {
    function GraphControlModule() {
    }
    return GraphControlModule;
}());
GraphControlModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_2__graph_control_component__["a" /* GraphControlComponent */]],
        exports: [__WEBPACK_IMPORTED_MODULE_2__graph_control_component__["a" /* GraphControlComponent */]]
    })
], GraphControlModule);

//# sourceMappingURL=graph-control.module.js.map

/***/ }),

/***/ "../../../../../src/app/webservice/graph-line/graph-line.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/webservice/graph-line/graph-line.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/webservice/graph-line/graph-line.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphLineComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var GraphLineComponent = (function () {
    function GraphLineComponent() {
        this.miniData = [1, 1, 1, 1];
        this.miniLabel = ['1', '2', '3', '4'];
        this.miniLegenda = '*Nº de casos por doença';
        this.miniName = 'x1';
    ...
    GraphLineComponent.prototype.ngOnInit = function () {
    };
    GraphLineComponent.prototype.uploadComplete = function (call) {
        this.uploaded.emit((call) ? 'ok' : 'no');
    };
    GraphLineComponent.prototype.open = function () {
        var _this = this;
    ...
    GraphLineComponent.prototype.rosca = function () {
        var _this = this;
        //console.log('rosca',this.miniLabel,this.miniData);
        //
        this.dataChart = new google.visualization.DataTable();
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], GraphLineComponent.prototype, "miniData", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], GraphLineComponent.prototype, "miniLabel", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], GraphLineComponent.prototype, "miniLegenda", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], GraphLineComponent.prototype, "miniName", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _a || Object)
], GraphLineComponent.prototype, "uploaded", void 0);
GraphLineComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-graph-line',
        template: __webpack_require__("../../../../../src/app/webservice/graph-line/graph-line.component.html"),
        styles: [__webpack_require__("../../../../../src/app/webservice/graph-line/graph-line.component.css")]
    }),
    __metadata("design:paramtypes", [])
], GraphLineComponent);

var _a;
//# sourceMappingURL=graph-line.component.js.map

/***/ }),

/***/ "../../../../../src/app/webservice/graph-line/graph-line.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphLineModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__graph_line_component__ = __webpack_require__("../../../../../src/app/webservice/graph-line/graph-line.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GraphLineModule = (function () {
    function GraphLineModule() {
    }
    return GraphLineModule;
}());
GraphLineModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_2__graph_line_component__["a" /* GraphLineComponent */]],
        exports: [__WEBPACK_IMPORTED_MODULE_2__graph_line_component__["a" /* GraphLineComponent */]]
    })
], GraphLineModule);

//# sourceMappingURL=graph-line.module.js.map

/***/ }),

/***/ "../../../../../src/app/webservice/graph-map/graph-map.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/webservice/graph-map/graph-map.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/webservice/graph-map/graph-map.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphMapComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var GraphMapComponent = (function () {
    ...
    GraphMapComponent.prototype.open = function () {
        var _this = this;
    ...
    GraphMapComponent.prototype.rosca = function () {
        var _this = this;
        this.dataChart = new google.visualization.DataTable();
        this.dataChart.addColumn('string', this.miniLegenda);
        this.dataChart.addColumn('number', 'Número');
        ...
        google.visualization.events.addListener(this.localchart, 'select', function (a, b, c) {
            ...
            if (selectedItem) {
                var topping = _this.dataChart.getValue(selectedItem.row, 0);
                //console.log('The user selected ' + topping);
                _this.updateMiniData('Chapecó, ' + topping, topping + ': 1');
            }
        });
        return this;
    };
    GraphMapComponent.prototype.updateMiniData = function (label, data) {
        //console.log(label);
        var tmp = [['Bairro', 'Doenças'],
            [label, label + ':' + data]];
        this.map(tmp);
    };
    GraphMapComponent.prototype.setMap = function () {
        var tmp = [];
        for (var i in this.miniLabel) {
    ...
    GraphMapComponent.prototype.map = function (tmp) {
        if (tmp === void 0) { tmp = []; }
        //console.log(tmp);
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], GraphMapComponent.prototype, "miniData", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], GraphMapComponent.prototype, "miniLabel", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], GraphMapComponent.prototype, "miniLegenda", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], GraphMapComponent.prototype, "miniName", void 0);
GraphMapComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-graph-map',
        template: __webpack_require__("../../../../../src/app/webservice/graph-map/graph-map.component.html"),
        styles: [__webpack_require__("../../../../../src/app/webservice/graph-map/graph-map.component.css")]
    }),
    __metadata("design:paramtypes", [])
], GraphMapComponent);
...
/***/ "../../../../../src/app/webservice/graph-map/graph-map.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphMapModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__graph_map_component__ = __webpack_require__("../../../../../src/app/webservice/graph-map/graph-map.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GraphMapModule = (function () {
    function GraphMapModule() {
    }
    return GraphMapModule;
}());
GraphMapModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_2__graph_map_component__["a" /* GraphMapComponent */]],
        exports: [__WEBPACK_IMPORTED_MODULE_2__graph_map_component__["a" /* GraphMapComponent */]]
    })
], GraphMapModule);

//# sourceMappingURL=graph-map.module.js.map
...
module.exports = "\n<app-graph-map  [miniData]=\"miniData\"   [miniLabel]=\"miniLabel\"   [miniLegenda]=\"miniLegenda\"   [miniName]=\"miniName\"></app-graph-map>\n\n<app-graph-line (uploaded)=\"someMethod($event)\" [miniData]=\"masterData\" [miniLabel]=\"masterLabel\" [miniLegenda]=\"masterLegenda\" [miniName]=\"masterName\"></app-graph-line>\n<app-sun *ngIf=\"vewSunburst\"></app-sun>\n\n<app-graph-control [miniData]=\"miniData1\" [miniLabel]=\"miniLabel1\" [miniLegenda]=\"miniLegenda1\" [miniMeses1]=\"miniMeses1\" [miniName]=\"miniName1\"></app-graph-control>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__graph_map_graph_map_component__ = __webpack_require__("../../../../../src/app/webservice/graph-map/graph-map.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__graph_line_graph_line_component__ = __webpack_require__("../../../../../src/app/webservice/graph-line/graph-line.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__graph_control_graph_control_component__ = __webpack_require__("../../../../../src/app/webservice/graph-control/graph-control.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WebserviceComponent = (function () {
    ...
    WebserviceComponent.prototype.randomizeType = function () {
        ...
        this.AppService.list(de, ate, 'bairro', '10').subscribe(function (response) { return _this.proccessB(response.json()); });
        this.AppService.list(de, ate, 'mes', '10').subscribe(function (response) { return _this.proccessC(response.json()); });
        this.AppService.month(de, ate, 'doenca', '20').subscribe(function (response) { return _this.month(response.json()); });
    };
    ...
    WebserviceComponent.prototype.month = function (e) {
        this.myControl.open_month(e);
    };
    WebserviceComponent.prototype.someMethod = function (event) {
        if (event == 'ok')
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_4__graph_map_graph_map_component__["a" /* GraphMapComponent */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__graph_map_graph_map_component__["a" /* GraphMapComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__graph_map_graph_map_component__["a" /* GraphMapComponent */]) === "function" && _a || Object)
], WebserviceComponent.prototype, "mySon", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_5__graph_line_graph_line_component__["a" /* GraphLineComponent */]),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__graph_line_graph_line_component__["a" /* GraphLineComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__graph_line_graph_line_component__["a" /* GraphLineComponent */]) === "function" && _b || Object)
], WebserviceComponent.prototype, "myLine", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_6__graph_control_graph_control_component__["a" /* GraphControlComponent */]),
    __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__graph_control_graph_control_component__["a" /* GraphControlComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__graph_control_graph_control_component__["a" /* GraphControlComponent */]) === "function" && _c || Object)
], WebserviceComponent.prototype, "myControl", void 0);
WebserviceComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__webservice_service__["a" /* WebserviceService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__webservice_service__["a" /* WebserviceService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__app_data__["a" /* AppData */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__app_data__["a" /* AppData */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__app_service__["a" /* AppService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__app_service__["a" /* AppService */]) === "function" && _f || Object])
], WebserviceComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__("../../../forms/@angular/forms.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__rosca_rosca_module__ = __webpack_require__("../../../../../src/app/rosca/rosca.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__zing_zing_module__ = __webpack_require__("../../../../../src/app/zing/zing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__graph_map_graph_map_module__ = __webpack_require__("../../../../../src/app/webservice/graph-map/graph-map.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__graph_line_graph_line_module__ = __webpack_require__("../../../../../src/app/webservice/graph-line/graph-line.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__graph_control_graph_control_module__ = __webpack_require__("../../../../../src/app/webservice/graph-control/graph-control.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__sunburst_sunburst_module__ = __webpack_require__("../../../../../src/app/sunburst/sunburst.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
WebserviceModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_6__rosca_rosca_module__["a" /* RoscaModule */],
            __WEBPACK_IMPORTED_MODULE_7__zing_zing_module__["a" /* ZingModule */],
            __WEBPACK_IMPORTED_MODULE_8__graph_map_graph_map_module__["a" /* GraphMapModule */],
            __WEBPACK_IMPORTED_MODULE_9__graph_line_graph_line_module__["a" /* GraphLineModule */],
            __WEBPACK_IMPORTED_MODULE_10__graph_control_graph_control_module__["a" /* GraphControlModule */],
            __WEBPACK_IMPORTED_MODULE_11__sunburst_sunburst_module__["a" /* SunburstModule */],
        ],
